      ...
      <Flex pl={90} pt={40} bg="linear-gradient(to right, #000E19, #192B36)">
        ...
        <Box p={2} flex="1">
          ...
          >
            ...
            for flowers. \n Elin Weijland, a true connoisseur of nature's
            ...
            Binding Blooms' exceptional creations. \n With an artist's eye and a
            deep understanding of the language of flowers, Elin has elevated the
            ...
            catering to various occasions, be it weddings, corporate events, or
            intimate gatherings. Elin's ability to capture the essence of each
            event and translate it into breathtaking floral designs is truly
            remarkable. Whether it's a lavish centerpiece, a delicate bridal
            bouquet, or a whimsical floral installation, Binding Blooms'
            creations leave a lasting impression.
          </Text>
        </Box>
      </Flex>
    </>
