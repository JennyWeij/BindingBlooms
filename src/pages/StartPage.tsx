    ...
    <>
      ...
      <Flex direction={["row"]}>
        <Box flex="1" p={20} bg="linear-gradient(to right, #000E19, #192B36)">
          ...
          <Box flex="1" p={4}>
            <Text fontFamily="SourceSansRegular" color="#B28767">
              ...
              passion for flowers. Elin Weijland, a true connoisseur of nature's
              wonders, is deeply devoted to the art of floral design. Her
              boundless passion for flowers serves as the driving force behind
              Binding Blooms' exceptional creations. With an artist's eye and a
              deep understanding of the language of flowers, Elin has elevated
              the act of binding bouquets into a symphony of colors, scents, and
              ...
              evoke emotions and tell stories. Binding Blooms specializes in
              catering to various occasions, be it weddings, corporate events,
              or intimate gatherings. Elin's ability to capture the essence of
              each event and translate it into breathtaking floral designs is
              truly remarkable. Whether it's a lavish centerpiece, a delicate
              bridal bouquet, or a whimsical floral installation, Binding
              Blooms' creations leave a lasting impression.
            </Text>
          </Box>
        </Box>
      </Flex>
